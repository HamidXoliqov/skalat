                    ...
                    <div class="box-body employee-info">
                            <table class="tablelist">
                                <tbody>
                                    ...
                                    <tr>
                                        <td><p>{{ __('Start date') }}</p></td>
                                        <td>
                                            <p>
                                            @isset($c->dateregularized) 
                                                @php echo e(date("F d, Y", strtotime($p->start_date))) @endphp
                                            @endisset
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><p>{{ __('End date') }}</p></td>
                                        <td>
                                            <p>
                                            @isset($c->dateregularized) 
                                                @php echo e(date("F d, Y", strtotime($p->end_date))) @endphp
                                            @endisset
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><p>{{ __('Start pice') }}</p></td>
                                        <td><p>@isset($p->price) {{ $p->price }} @endisset</p></td>
                                    </tr>
                                </tbody>
                            </table>
                    </div>
